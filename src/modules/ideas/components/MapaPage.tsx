    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="glass-hero p-5">
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div key={s.label} style={{ background: 'rgba(255,255,255,0.07)', borderRadius: 10, padding: '8px', textAlign: 'center' }}>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="glass flex flex-1 cursor-pointer flex-col items-center px-3 py-2.5 transition-all hover:bg-[rgba(255,255,255,0.09)]"
        >
          <span className="text-base">👂</span>
          <span style={{ marginTop: 2, fontSize: 11, fontWeight: 600, color: 'var(--text-primary)', fontFamily: 'var(--font-sans)' }}>Cazador</span>
          <span style={{ fontSize: 10, color: 'var(--text-muted)' }}>Registrar observación</span>
        </button>
        <button
        ...
        >
          <span className="text-base">💡</span>
          <span style={{ marginTop: 2, fontSize: 11, fontWeight: 600, color: 'var(--text-primary)', fontFamily: 'var(--font-sans)' }}>Mis Ideas</span>
          <span style={{ fontSize: 10, color: 'var(--text-muted)' }}>Ver banco de ideas</span>
        </button>
      </div>
      ...
      <div className="flex flex-col gap-2.5">
        {caminosWithMatch.map(c => (
          <button
            ...
            className="glass w-full p-4 text-left transition-all hover:bg-[rgba(255,255,255,0.09)]"
            ...
            <div className="flex items-start gap-3">
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 2 }}>
                  <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)', fontFamily: 'var(--font-sans)' }}>{c.titulo}</span>
                  <span
                    style={{
